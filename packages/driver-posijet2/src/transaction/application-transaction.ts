...
export const SendCmppProgram = <T extends AnyDriver>(program: UserProgram<T>, device: Device<T>): Promise<void> => {
...
export const ReadCmppProgram = <T extends AnyDriver>(program: UserProgram<T>, device: Device<T>): Promise<UserProgram<T>> => {
