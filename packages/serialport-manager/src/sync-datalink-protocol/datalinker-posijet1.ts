...
import { Datalinker, ResultError, ReceptionHandlerResult, ResultProcessing, ResultSucessful } from '../core-models/datalinker-sync'
import { Byte, Bytes } from '../core-models/bytes'
